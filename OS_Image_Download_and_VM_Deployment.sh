...
glance --os-image-api-version 1 image-create --container-format bare --disk-format qcow2 --min-disk 8 --min-ram 1024 --is-public True --location http://cloud.centos.org/centos/7/images/CentOS-7-x86_64-GenericCloud-1705.qcow2 --name "CentOS-7"
...
openstack image create --property hypervisor_type=QEMU --property os_type=windows --container-format bare --disk-format qcow2 --min-disk 40 --min-ram 4096 --public Windows-Server-2012-R2
